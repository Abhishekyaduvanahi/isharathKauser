...
const Home = () => {
  return (
    <section
      id="home"
      className="h-screen md:h-screen flex  flex-col justify-center items-center"
    >
      ...
      <div className=" flex flex-col md:flex-row justify-center items-center  ">
        ...
        <div className=" flex flex-col  ">
          <p className=" font-serif text-[40px] md:text-[60px]  font-bold p-18 mx-auto">
            {about.name}
          </p>
      ...
      <p className="md:w-[40%] w-[80%] font-sans mb-2 p-8 md:text-[30px]">
        {about.description}
      </p>
