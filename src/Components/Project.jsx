...
import projectImgae1 from "../assets/todo.jpeg";
import projectImgae2 from "../assets/chessAiMaster.jpeg";
...
const Project = () => {
  return (
    <section id="projects" className="h-auto flex flex-col ">
      <h1 className=" text-[50px]  font-bold mx-auto mt-2">Projects</h1>

      {/* card main container */}
      <div className="flex flex-col items-center  md:flex-row ">
        {/* 1st card */}
        <div className="bg-slate-100  flex flex-col w-[95%] h-auto rounded-2xl m-4 p-8 ">
